...
(function () {
  ...
  function addCSS() {
    ...
    style.textContent = `
      .ss-size-box{width:min(94%,430px);margin:12px auto 18px;padding:14px;border:2px solid #111;border-radius:16px;background:#000;text-align:center;box-shadow:0 4px 14px rgba(0,0,0,.12);box-sizing:border-box;clear:both;display:block!important;position:relative;z-index:9;}
      .ss-size-title{font-size:16px;font-weight:800;margin-bottom:10px;color:#fff;}
      ...
      .ss-size-note{margin-top:8px;font-size:12px;color:#fff;}
    `;
